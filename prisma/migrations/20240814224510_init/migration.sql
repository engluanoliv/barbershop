...
CREATE TABLE "BarbershopBarber" (
    ...
    CONSTRAINT "BarbershopBarber_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "BarberSlot" (
    ...
    CONSTRAINT "BarberSlot_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "BarbershopService" ADD CONSTRAINT "BarbershopService_serviceId_fkey" FOREIGN KEY ("serviceId") REFERENCES "Service"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BarbershopBarber" ADD CONSTRAINT "BarbershopBarber_barbershopId_fkey" FOREIGN KEY ("barbershopId") REFERENCES "Barbershop"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BarbershopBarber" ADD CONSTRAINT "BarbershopBarber_barberId_fkey" FOREIGN KEY ("barberId") REFERENCES "Barber"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "BarberSlot" ADD CONSTRAINT "BarberSlot_barberId_fkey" FOREIGN KEY ("barberId") REFERENCES "Barber"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BarberSlot" ADD CONSTRAINT "BarberSlot_slotId_fkey" FOREIGN KEY ("slotId") REFERENCES "Slot"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
